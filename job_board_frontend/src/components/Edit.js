    ...
    const handleSubmit = (event) => {
        ...
        if (form.checkValidity() === false) {
            ...
            const data = {
                ...
                "companieId": props.prop.id
            };
            const url_edit = 'http://localhost:8080/api/advertisement/' + props.prop.id
            const options = {
                method: 'PUT',
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title>Edit an advertisement</Modal.Title>
                </Modal.Header>
                <div className='add'>
